...
#define LV_USE_LESSON_DEMO_5_1        0     // LVGL文件系统模块的用法
#define LV_USE_LESSON_DEMO_5_2        0     // 通过LVGL文件系统模块的显示图片文件
#define LV_USE_LESSON_DEMO_5_3        0     // FreeType控件（lv_freetype）的用法
#define LV_USE_LESSON_DEMO_5_4        1     // 二维码控件(lv_qrcode)的用法
#define LV_USE_LESSON_DEMO_5_5        1     // 条形码控件(lv_barcode)的用法
#define LV_USE_LESSON_DEMO_6_1        0     // 文件资源管理器控件（lv_file_explorer）的用法
...
#define LV_USE_LESSON_DEMO_7_6        0     // 物理按键代替触摸（鼠标模仿编码器）
#define LV_USE_LESSON_DEMO_7_7        0     // Windows HOOK拦截键盘输入模拟按键输入
