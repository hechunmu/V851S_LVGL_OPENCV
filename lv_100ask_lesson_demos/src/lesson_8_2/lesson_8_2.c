...
#if LV_USE_LESSON_DEMO_8_2 && LV_USE_LOG

#include "lesson_8_2.h"
 ...
 *   GLOBAL FUNCTIONS
 **********************/
void lesson_8_2(void)
{
#if 1 // 8_2
    // 在 lv_conf.h 中配置 LV_USE_LOG
